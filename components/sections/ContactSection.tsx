          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass rounded-2xl p-6 border border-white/5">
              <div className="flex flex-col gap-3">
                {[
                  { emoji: '🔒', text: 'Información 100% confidencial' },
                  { emoji: '⚡', text: 'Respuesta en menos de 24h' },
                  { emoji: '🎯', text: 'Consultoría inicial gratuita' },
                  { emoji: '📋', text: 'Propuesta sin compromiso' },
                ].map((item) => (
              ...
              {sent ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-6 px-5 py-2.5 rounded-xl text-sm border border-white/10 hover:bg-white/5 transition-all cursor-pointer"
                  >
                    Enviar otro mensaje
                  </button>
                </motion.div>
